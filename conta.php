...
<meta charset="utf-8">
	...
	<div class="bem-vindo">
		...
		<h3>
			...
			<a href="alterarcadastro.php" class="botaopesquisa">Cadastro</a>//
...
<body>
	...
	<div class="borda-formulario">
		...
		<h3><h1>Lista de vendas dos produtos </h1></h3>
    <form action="">
        <input name="busca"  class="pesquisa" value="<?php if(isset($_GET['busca'])) echo $_GET['busca']; ?>" placeholder="Digite o produto " type="text">
    ...
    <table width="auto" margin-left="auto" border="1" text-align="center" font-style="italic" font-size="1.5vw">
			<center>
        <tr>
            <th><h3>Codigo do produto</h3></th>
            <th><h3>cpf</h3></th>
            <th><h3>Nome do produto</h3></th>
			<th><h3> Codigo do cliente</h3></th>
        ...
        <?php
            ...
            $sql_code = "SELECT *
                FROM vendas,produto
                WHERE codigoproduto LIKE '%$pesquisa%' 
                OR email LIKE '%$pesquisa%'
				OR nomeproduto LIKE '%$pesquisa%'
                OR datavenda LIKE '%$pesquisa%'
				";
            ...
            if ($sql_query->num_rows == 0) {
                ?>
            <tr>
               <h3> <td colspan="6"> <h3>Nenhum resultado encontrado...</h3></td> 
            </tr>
            <?php
            } else {
                while($dados = $sql_query->fetch_assoc()) {
                    ?>
					<tr class="h3"> 
                        <td><h3><?php echo $dados['codigoproduto']; ?></h3></td>
                        <td><h3><?php echo $dados['email']; ?></h3></td>
						<td><h3><?php echo $dados['nomeproduto']; ?></h3></td>
						<td><h3><?php echo $dados['datavenda']; ?></h3></td>
						<td><h3><?php echo "<a class='botaopesquisa' href='apagar.php?codigovenda=" .$dados['codigovenda'] . "'>Apagar</a>";?></h3></td>
